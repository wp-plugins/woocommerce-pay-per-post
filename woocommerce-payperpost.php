...
if (!class_exists('Woocommerce_PayPerPost')) {
    ...
    class Woocommerce_PayPerPost {
        ...
        public static function get($value, $id) {
            if (empty($id)) {
                global $post;
                $id = $post->ID;
            }
        ...
        public static function save_custom_meta_box($post_id) {
            ...
            if (isset($_POST['woocommerce_ppp_product_id'])) {
                update_post_meta($post_id, 'woocommerce_ppp_product_id', esc_attr($_POST['woocommerce_ppp_product_id']));
            }
        }
        ...
        public static function render($content) {
            ...
            if (!empty($productID)) {
                if (is_user_logged_in() && self::checkForProduct($productID)) {
                    return $content;
                } else {
